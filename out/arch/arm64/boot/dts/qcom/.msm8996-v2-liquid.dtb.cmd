cmd_arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dtb := ../scripts/gcc-wrapper.py aarch64-linux-android-gcc -E -Wp,-MD,arch/arm64/boot/dts/qcom/.msm8996-v2-liquid.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.msm8996-v2-liquid.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/  -d arch/arm64/boot/dts/qcom/.msm8996-v2-liquid.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.msm8996-v2-liquid.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.msm8996-v2-liquid.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.msm8996-v2-liquid.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.msm8996-v2-liquid.dtb.d

source_arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dtb := ../arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dts

deps_arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dtb := \
...
arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dtb: $(deps_arch/arm64/boot/dts/qcom/msm8996-v2-liquid.dtb)
