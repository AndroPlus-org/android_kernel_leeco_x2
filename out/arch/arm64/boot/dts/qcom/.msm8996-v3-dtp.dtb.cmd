cmd_arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dtb := ../scripts/gcc-wrapper.py aarch64-linux-android-gcc -E -Wp,-MD,arch/arm64/boot/dts/qcom/.msm8996-v3-dtp.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.msm8996-v3-dtp.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/  -d arch/arm64/boot/dts/qcom/.msm8996-v3-dtp.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.msm8996-v3-dtp.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.msm8996-v3-dtp.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.msm8996-v3-dtp.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.msm8996-v3-dtp.dtb.d

source_arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dtb := ../arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dts

deps_arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dtb := \
...
arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dtb: $(deps_arch/arm64/boot/dts/qcom/msm8996-v3-dtp.dtb)
